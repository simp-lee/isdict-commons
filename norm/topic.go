...
func buildTopicToDomainMap() map[string]string {
	mappings := make(map[string]string, 160)
	...
	add(model.DomainLabelComputing, "computing", "programming", "computer-science", "software", "Internet", "object-oriented-programming", "java-programming-language", "machine-learning", "artificial-intelligence")
	...
	add(model.DomainLabelSports, "sports", "football", "cricket", "baseball", "tennis", "basketball", "ball-games", "martial-arts", "soccer", "roller-derby", "Australian-rules-football", "croquet", "field-sports", "combat-sports", "bobsledding", "ultimate-frisbee", "American-football")
	...
	add(model.DomainLabelPhysics, "physics", "optics", "quantum-mechanics", "quantum mechanics", "nuclear-physics", "nuclear physics", "thermodynamics", "energy", "electricity")
	...
	add(model.DomainLabelGeology, "geology", "planetary-geology", "planetary geology")
	add(model.DomainLabelAviation, "aviation", "aeronautics")
	...
	add(model.DomainLabelGames, "games", "board-games", "video-games", "roleplaying-games", "puzzles", "chess")
	add(model.DomainLabelMedia, "media", "publishing", "film", "television", "video-editing", "video editing", "sound-recording", "sound recording", "sound-engineering", "sound engineering")
	add(model.DomainLabelEducation, "education", "academia")
	add(model.DomainLabelTransport, "transport", "rail-transport", "rail transport")
	...
	add(model.DomainLabelMeteorology, "meteorology", "weather")
